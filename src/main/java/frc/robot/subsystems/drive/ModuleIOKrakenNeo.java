...
public class ModuleIOKrakenNeo implements ModuleIO {
  ...
  public ModuleIOKrakenNeo(int index) {
    ...
    switch (index) {
      case 0:
        driveTalonFX =
            new TalonFX(DriveConstants.DRIVE_MOTOR.FRONT_RIGHT.CAN_ID);
      ...
      case 1:
        ...
        driveTalonFX =
            new TalonFX(DriveConstants.DRIVE_MOTOR.FRONT_LEFT.CAN_ID);
      ...
      case 2:
        ...
        driveTalonFX =
            new TalonFX(DriveConstants.DRIVE_MOTOR.BACK_LEFT.CAN_ID);
      ...
      case 3:
        ...
        driveTalonFX =
            new TalonFX(DriveConstants.DRIVE_MOTOR.BACK_RIGHT.CAN_ID);
