        ...
        new RunCommand(
            () ->
                m_driveSubsystem.driveWithDeadband(
                    driverController.getLeftX() * .35, // Forward/backward
                    -driverController.getLeftY()
                        * 0.35, // Left/Right (multiply by -1 bc controller axis is inverted)
                    driverController.getRightX() * (-0.35)), // Rotate chassis left/right
            m_driveSubsystem));
